    ...
    protected void onStart() {
        ...
        countDownTimer = new CountDownTimer(randNL, 1000) {
            public void onTick(long millisUntilFinished) {
                ...
                ImageButton p4Button = (ImageButton) findViewById(R.id.buttonP4_2);
                ImageButton p4_2Button = (ImageButton) findViewById(R.id.buttonP4);
                p4_2Button.setVisibility(View.GONE);
                p4Button.setVisibility(View.VISIBLE);
                ...
                p4Button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        TextView text4 = (TextView) findViewById(R.id.player4TextView);
                        text4.setText("TOO EARLY!");
                        cancel();
                        start();
                    }
                });
            ...
            public void onFinish() {
                ...
                ImageButton p4_2Button = (ImageButton) findViewById(R.id.buttonP4_2);
                ...
                p4Button.setVisibility(View.GONE);
                p4_2Button.setVisibility(View.VISIBLE);
                TextView text1=(TextView)findViewById(R.id.player1TextView);
                text1.setText("PRESS!!!");
                TextView text2=(TextView)findViewById(R.id.player2TextView);
                text2.setText("PRESS!!!");
                ...
                p4_2Button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(FourPlayerModeActivity.this);
                        builder.setTitle("Player4 Clicked The Button!")
                                .setCancelable(false)
                                .setMessage("Player4's time was " + (System.currentTimeMillis() - initialTime) + " milliseconds. Play Again ?")
                                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int num) {
                                        dialog.cancel();
                                        Intent intent = getIntent();
